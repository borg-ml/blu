...
needles, nil misses, explicit plain mode, basic anchors, wildcard bytes, and
escaped punctuation under a work limit. Unimplemented Lua-pattern syntax fails
structurally instead of being treated as literal text.
