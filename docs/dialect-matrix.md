...
| `ASSIGN` | `experimental` | `experimental` | `unsupported` | Luau-generated bytecode covers basic tables, assignments, varargs, and multires. Owned BluV1 covers raw bracket-indexed single-target reads/writes; constructor fields, assignment-list ordering, and metamethod-aware access remain absent. |
