...
| `ASSIGN` | `experimental` | `experimental` | `experimental` | Luau-generated bytecode covers basic tables, assignments, varargs, and multires. Owned BluV1 covers source-ordered constructor fields, raw bracket/dot reads and writes, and simultaneous mixed identifier/index/field assignment lists whose targets and right-hand sides are snapshotted before source-order commits. Metamethod-aware access and final constructor-field MULTRET remain absent. |
